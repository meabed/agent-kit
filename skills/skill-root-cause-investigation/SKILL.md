...
description: 'This skill should be used when the user asks to apply "Root-cause investigation before edits", mentions "skill-root-cause-investigation", or needs this workflow: Find the exact source with file:line, name the systemic cause, and avoid masking symptoms with a patch.'
version: 0.1.0
---
