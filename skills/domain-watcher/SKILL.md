---
name: domain-watcher
description: 'This skill should be used when the user asks to apply "Domain and TLS expiry watcher", mentions "domain-watcher", or needs this workflow: A daily check that ranks domains and certificates by expiry, then keeps one rolling issue current.'
version: 0.1.0
---
