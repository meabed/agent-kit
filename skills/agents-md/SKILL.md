---
name: agents-md
description: 'This skill should be used when the user asks to apply "AGENTS.md as the house-style file", mentions "agents-md", or needs this workflow: One place for toolchain, code style, and repo invariants, with every other agent note pointing back to it.'
version: 0.1.0
---
