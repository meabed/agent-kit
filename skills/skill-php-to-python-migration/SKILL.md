...
description: 'This skill should be used when the user asks to apply "PHP to Python with golden-file parity", mentions "skill-php-to-python-migration", or needs this workflow: Move behavior across languages with fixture proof, uv tooling, and boring first-party libraries where they fit.'
version: 0.1.0
---
