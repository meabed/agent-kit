---
name: pg-explain
description: 'This skill should be used when the user asks to apply "Teach agents to read EXPLAIN", mentions "pg-explain", or needs this workflow: Give it the plan, get back the slow node, estimate drift, and the index worth testing.'
version: 0.1.0
---
