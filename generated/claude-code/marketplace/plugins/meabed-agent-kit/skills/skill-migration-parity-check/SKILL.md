...
description: 'This skill should be used when the user asks to apply "Prove parity during a refactor", mentions "skill-migration-parity-check", or needs this workflow: Capture reference behavior, separate public from internal fields, and make the new path match what matters.'
version: 0.1.0
---
