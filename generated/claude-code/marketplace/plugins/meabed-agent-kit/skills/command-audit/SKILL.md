---
name: command-audit
description: 'This skill should be used when the user asks to apply "Read-only audit with file:line findings", mentions "command-audit", or needs this workflow: A strict no-write pass that reports one concrete finding per line, sorted by impact.'
version: 0.1.0
---
