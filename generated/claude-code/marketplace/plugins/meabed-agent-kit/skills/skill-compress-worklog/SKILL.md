---
name: skill-compress-worklog
description: 'This skill should be used when the user asks to apply "Compress a worklog without losing signal", mentions "skill-compress-worklog", or needs this workflow: Turn messy session notes into a dense developer journal while preserving decisions, commands, and evidence.'
version: 0.1.0
---
