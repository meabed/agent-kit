...
description: 'This skill should be used when the user asks to apply "Incident timelines while evidence is fresh", mentions "incident-copilot", or needs this workflow: An agent follows logs and metrics during an incident so the timeline is accurate before context fades.'
version: 0.1.0
---
