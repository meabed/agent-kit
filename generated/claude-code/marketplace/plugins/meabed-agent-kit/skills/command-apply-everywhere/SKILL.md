...
description: 'This skill should be used when the user asks to apply "Fix the whole pattern, not one instance", mentions "command-apply-everywhere", or needs this workflow: Find every occurrence, patch the full surface, and write the rule down so the drift does not come back.'
version: 0.1.0
---
