---
name: command-commit-push-pr
description: 'This skill should be used when the user asks to apply "Commit, push, and open the PR cleanly", mentions "command-commit-push-pr", or needs this workflow: Branch when needed, make one conventional commit, keep the PR scoped, and report the exact SHA.'
version: 0.1.0
---
