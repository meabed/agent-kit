---
name: command-plan
description: 'This skill should be used when the user asks to apply "Plan before touching the code", mentions "command-plan", or needs this workflow: For large or ambiguous work: inspect first, write the steps, ask the blocking questions, then execute.'
version: 0.1.0
---
