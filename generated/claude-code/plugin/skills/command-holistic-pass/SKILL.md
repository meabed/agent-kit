...
description: 'This skill should be used when the user asks to apply "Final cleanup pass before calling it done", mentions "command-holistic-pass", or needs this workflow: Re-scan the whole project for leftovers, stale docs, missed simplifications, and rule violations.'
version: 0.1.0
---
