...
description: 'This skill should be used when the user asks to apply "Postmortems from logs, not memory", mentions "postmortem-prompt", or needs this workflow: Turn the incident channel and system evidence into a timeline that names systems, never people.'
version: 0.1.0
---
