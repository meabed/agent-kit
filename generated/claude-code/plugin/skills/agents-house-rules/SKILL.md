...
description: 'This skill should be used when the user asks to apply "House rules agents can actually follow", mentions "agents-house-rules", or needs this workflow: The recurring repo rules: cleanup, stack, schemas, IDs, and CI, written as constraints an agent can check.'
version: 0.1.0
---
