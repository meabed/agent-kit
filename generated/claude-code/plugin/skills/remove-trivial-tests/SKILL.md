...
description: 'This skill should be used when the user asks to apply "Remove trivial tests before they harden", mentions "remove-trivial-tests", or needs this workflow: An agent skill for replacing shallow AI-written coverage with tests that can catch real regressions.'
version: 0.1.0
---
