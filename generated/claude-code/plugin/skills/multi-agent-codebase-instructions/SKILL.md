...
description: 'This skill should be used when the user asks to apply "How to Structure Coding-Agent Instructions in a Large Codebase", mentions "multi-agent-codebase-instructions", or needs this workflow: A practical layout for AGENTS.md, CLAUDE.md, Copilot instructions, scoped folder rules, and docs when several agents work in...'
version: 0.1.0
---
