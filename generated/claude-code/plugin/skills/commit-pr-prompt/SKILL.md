---
name: commit-pr-prompt
description: 'This skill should be used when the user asks to apply "Commit and PR text from the real diff", mentions "commit-pr-prompt", or needs this workflow: A conventional commit subject and PR body that say what changed, why it matters, and how it was checked.'
version: 0.1.0
---
