---
name: command-report
description: 'This skill should be used when the user asks to apply "End-of-task reports that are useful later", mentions "command-report", or needs this workflow: A short closeout with changed files, commands and results, decisions made, and honest follow-up.'
version: 0.1.0
---
