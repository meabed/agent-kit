---
name: command-verify
description: 'This skill should be used when the user asks to apply "Verification gate before done", mentions "command-verify", or needs this workflow: Run typecheck, lint, tests, API flow, and build; keep fixing until the repo agrees.'
version: 0.1.0
---
