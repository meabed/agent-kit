---
name: review-prompt
description: 'This skill should be used when the user asks to apply "Staff-engineer review with a narrow charter", mentions "review-prompt", or needs this workflow: A terse review prompt for correctness, retry-safety, blast radius, and the smallest useful fix.'
version: 0.1.0
---
