---
name: command-holistic-pass
description: 'Re-scan the whole project for leftovers, stale docs, missed simplifications, and rule violations.'
agent: agent
---

# Agent prompt: Final cleanup pass before calling it done
...
- Resource: Final cleanup pass before calling it done
- Type: loop
- Site URL: https://mo.ca/ai/command-holistic-pass
- Source artifact: `commands/holistic-pass.md`
- Topics: loop
