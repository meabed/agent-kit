---
name: agents-house-rules
description: 'The recurring repo rules: cleanup, stack, schemas, IDs, and CI, written as constraints an agent can check.'
agent: agent
---

# Agent prompt: House rules agents can actually follow
...
- Resource: House rules agents can actually follow
- Type: agent
- Site URL: https://mo.ca/ai/agents-house-rules
- Source artifact: `AGENTS.snippet.md`
- Topics: agent
