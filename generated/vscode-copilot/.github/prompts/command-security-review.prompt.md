...
description: 'A read-only pass over dependency bumps, auth changes, and CI edits, with a fixed checklist and findings format.'
agent: agent
---

# Agent prompt: Security review of the actual diff
...
- Resource: Security review of the actual diff
- Type: command
- Site URL: https://mo.ca/ai/command-security-review
- Source artifact: `commands/security-review.md`
- Topics: command
