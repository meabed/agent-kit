---
name: multi-agent-codebase-instructions
description: 'A practical layout for AGENTS.md, CLAUDE.md, Copilot instructions, scoped folder rules, and docs when several agents work in the same repo.'
agent: agent
---

# Agent prompt: How to Structure Coding-Agent Instructions in a Large Codebase
...
- Resource: How to Structure Coding-Agent Instructions in a Large Codebase
- Type: agent
- Site URL: https://mo.ca/ai/multi-agent-codebase-instructions
- Topics: agent, config
