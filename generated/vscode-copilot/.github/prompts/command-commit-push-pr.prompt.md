...
# Agent prompt: Commit, push, and open the PR cleanly
...
- Resource: Commit, push, and open the PR cleanly
- Type: command
- Site URL: https://mo.ca/ai/command-commit-push-pr
- Source artifact: `commands/commit-push-pr.md`
- Topics: command
