---
name: skill-php-to-python-migration
description: 'Move behavior across languages with fixture proof, uv tooling, and boring first-party libraries where they fit.'
agent: agent
---

# Agent prompt: PHP to Python with golden-file parity
...
- Resource: PHP to Python with golden-file parity
- Type: skill
- Site URL: https://mo.ca/ai/skill-php-to-python-migration
- Source artifact: `skills/php-to-python-migration/SKILL.md`
- Topics: skill
