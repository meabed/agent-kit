---
description: 'The short token and component contract that stops agent-built UI from drifting into visual noise.'
---

# Agent prompt: design.md for keeping generated UI on-system
...
- Resource: design.md for keeping generated UI on-system
- Type: config
- Site URL: https://mo.ca/ai/design-md
- Topics: config
