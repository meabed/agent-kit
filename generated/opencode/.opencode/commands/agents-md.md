---
description: 'One place for toolchain, code style, and repo invariants, with every other agent note pointing back to it.'
---

# Agent prompt: AGENTS.md as the house-style file
...
- Resource: AGENTS.md as the house-style file
- Type: config
- Site URL: https://mo.ca/ai/agents-md
- Source artifact: `AGENTS.md`
- Topics: config
