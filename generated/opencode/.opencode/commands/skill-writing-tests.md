---
description: 'Behavior checks, negative cases, regression coverage, and cleanup that keeps the next run honest.'
---

# Agent prompt: Write tests that can actually fail
...
- Resource: Write tests that can actually fail
- Type: skill
- Site URL: https://mo.ca/ai/skill-writing-tests
- Source artifact: `skills/writing-tests/SKILL.md`
- Topics: skill
