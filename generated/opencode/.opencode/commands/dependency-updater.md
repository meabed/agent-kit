---
description: 'A scheduled job bumps packages, runs the repo checks, and pushes only when the branch earns it.'
---

# Agent prompt: Dependency updates that only land green
...
- Resource: Dependency updates that only land green
- Type: workflow
- Site URL: https://mo.ca/ai/dependency-updater
- Source artifact: `update-deps.ts`
- Topics: workflow
