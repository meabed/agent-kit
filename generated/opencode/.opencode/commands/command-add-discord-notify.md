...
# Agent prompt: Add Discord notifications without breaking Slack
...
- Resource: Add Discord notifications without breaking Slack
- Type: command
- Site URL: https://mo.ca/ai/command-add-discord-notify
- Source artifact: `commands/add-discord-notify.md`
- Topics: command
