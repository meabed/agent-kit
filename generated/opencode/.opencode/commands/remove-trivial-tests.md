---
description: 'An agent skill for replacing shallow AI-written coverage with tests that can catch real regressions.'
---

# Agent prompt: Remove trivial tests before they harden
...
- Resource: Remove trivial tests before they harden
- Type: skill
- Site URL: https://mo.ca/ai/remove-trivial-tests
- Source artifact: `skills/remove-trivial-tests/SKILL.md`
- Topics: skill, testing, defensive-programming, ai
