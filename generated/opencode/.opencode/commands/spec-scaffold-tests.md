---
description: 'Write the design first, let the agent scaffold the shape and failing tests, then fill in the logic.'
---

# Agent prompt: Spec, scaffold, then tests
...
- Resource: Spec, scaffold, then tests
- Type: workflow
- Site URL: https://mo.ca/ai/spec-scaffold-tests
- Topics: workflow
